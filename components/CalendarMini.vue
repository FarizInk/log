...
<template>
  <div :class="['text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 xl:col-start-9', minW]">
    <div class="flex items-center text-gray-900">
      ...
      <div class="flex-auto text-sm font-semibold text-white">January</div>
      <button type="button"
        class="-m-1.5 flex flex-none items-center justify-center p-1.5 text-gray-400 hover:text-gray-500">
    ...
    <div class="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-blck-100 text-sm shadow ring-1 ring-blck-100">
      <!--
        ...
        -->
      <button type="button" class="rounded-tl-lg bg-blck-900 py-1.5 text-gray-500 hover:bg-blck-500 focus:z-10">
        <!--
      ...
      <button type="button" class="bg-blck-900 py-1.5 text-gray-500 hover:bg-blck-500 focus:z-10">
      ...
      <button type="button" class="bg-black py-1.5 text-white hover:bg-blck-500 focus:z-10">
        <time datetime="2022-01-01" class="mx-auto flex h-7 w-7 items-center justify-center rounded-full">1</time>
      </button>
      <button type="button" class="rounded-tr-lg bg-black py-1.5 text-white hover:bg-blck-500 focus:z-10">
      ...
      <button type="button" class="bg-indigo-600 py-1.5 font-semibold text-white hover:bg-indigo-600 focus:z-10">
      ...
      <button type="button" class="bg-black py-1.5 text-white hover:bg-blck-500 focus:z-10">
        <time datetime="2022-01-22"
          class="mx-auto flex h-7 w-7 items-center justify-center rounded-full bg-blck-50 font-semibold text-white">22</time>
      </button>
      <button type="button" class="bg-black py-1.5 text-white hover:bg-blck-500 focus:z-10">
      ...
      <button type="button" class="rounded-bl-lg bg-black py-1.5 text-white hover:bg-blck-500 focus:z-10">
      ...
      <button type="button" class="rounded-br-lg bg-blck-900 py-1.5 text-gray-500 hover:bg-blck-500 focus:z-10">
